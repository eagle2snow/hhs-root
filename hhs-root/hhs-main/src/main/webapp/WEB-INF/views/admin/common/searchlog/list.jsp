...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
								...
								<table  class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<th class="text-center"><img src='${model.thumb}' style="width: 50pxp; height: 50px;" /></th>
											
											
											
											 <th>${model.keyWord}</th>
											
											 <th>${model.priority}</th>
											
											 <th>${model.model}</th>
											
											 <th>${model.modelId}</th>
											
											<td><javatime:format value="${model.creationTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
											<td class="td-status">
		...
		function edit(id){
				...
				openPerRe("编辑搜索记录", 90,90,'${adp}update/'+id+'.htm');
