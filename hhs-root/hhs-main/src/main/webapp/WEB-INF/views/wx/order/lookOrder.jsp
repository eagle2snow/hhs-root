...
<body>
	...
	<!--商品-->
	<div class="content1">
		<img src="/static/wx/images/details/02.png" />

		<ul>
			<c:forEach items="${items}" var="item">
				<li>名称 ${item["showRemarks"]} 数量 ${item["buyCount"]} 单价
					${item["showPrice"]}</li>
			</c:forEach>
			<li style="float: right; margin-right: 2rem; margin-top: 2rem;">共
				${itemSize} 件商品 总计：￥59.90</li>
		</ul>
	...
	<div class="content2">
		<ul>
			...
			<li style="height: 6rem;"><span class="span2">
			<img src="/static/wx/images/details/personal.png"/><a>个人中心</a></span> <span class="span1">
			<img src="/static/wx/images/details/contentSeller.png" /><a>联系卖家</a></span></li>
		</ul>
	</div>
	...
	<div class="footer">
		<ul>
			...
			<li>微信支付： <span>${order["wxNumber"]}</span></li>
			<li>创建时间：<span>${order["createTime"]}</span></li>
			<li style="margin-bottom: 2rem;">付款时间： <span>2018-05-21 13：56：55</span></li>
		</ul>
	</div>
</body>
</html>
