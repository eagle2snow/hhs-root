...
<!-- 一行 -->
<div class="ntbox">
	<div class="ntbox_dt"><i class="md_error_ntico ntico"></i>支付失败</div>
	<div class="ntbox_dd">对不起，支付遇到问题，您可以：</div>
</div>
<div class="mt80 spcbtnrow">
	<div class="spcbtnrow_item"><a href="history.go(-1)" class="warnbtn mdbtn">重新支付</a></div>
	<div class="spcbtnrow_item"><a href="${ctx}/wx/chat" class="secondbtn mdbtn">联系客服</a></div>
</div>
<!-- end 一行 -->
<!--end 中间-->
