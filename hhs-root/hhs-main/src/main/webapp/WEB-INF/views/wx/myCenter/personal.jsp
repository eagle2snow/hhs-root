...
<div class="cutuser wbox">
    <a class="cutuser_produce">
        ...
        <i onclick="editProfile(${member.id})" class="rgt"></i>
    </a>
</div>
<!-- end 一行 -->
<!-- 一行 -->
        ...
        <div class="ntcpop_container">
            ...
            <div class="ntcpop_mc">
                <div class="dtitem">
                    <div class="dl">
                        <div class="dd">
                            <input type="text" onFocus=OnEnter(this) onBlur=OnExit(this) value="请输入推荐人推广ID"
                                   class="dtint" name="referrerGeneralizeId">
                        </div>
                    </div>
