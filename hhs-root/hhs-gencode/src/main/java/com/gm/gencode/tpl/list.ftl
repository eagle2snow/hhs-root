										...
										<div class="cl pd-5 bg-1 bk-gray mt-20">
											<span class="l"><a href="javascript:;"
												onclick="delByIds('${r"${adp}"}')" class="btn btn-danger radius"><i
													...
													onclick="openPerRe('添加',90,90,'${r"${adp}"}add.htm')"
								...
								<table  class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<button onclick="edit(${r"${model.id}"})"  class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-pencil" title="修改"></i></button>
