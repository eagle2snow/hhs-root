							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.totalMoney}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.postageMoney}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.status}"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.orderRefundTime}"
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.firstLevelBrokerage}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.secondLevelBrokerage}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.payPathway}"
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.appraise}"
