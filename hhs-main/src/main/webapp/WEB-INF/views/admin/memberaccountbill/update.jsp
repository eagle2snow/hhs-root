					...
					<div class="box-header with-border">
						<h3 class="box-title">编辑</h3>
								...
								<div class="col-sm-8">
	                               ...
	                               <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select name="order.id" style="width: 100% !important;" class="form-control select2" id="order">
												<c:forEach items="${orderList}" var="m">
													<option    ${model.order.id==m.id?'selected':'' }  value="${m.id}">
														${m.name}
													</option>
												</c:forEach> 
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="number" class="form-control" value="${model.type}"
								        	placeholder="类型" id="type" name="type" />
										</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="${model.money}"
							        placeholder="金额" id="money" name="money"           />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
							        ...
							        placeholder="备注" id="remark" name="remark"           />
								</div>
							</div>
