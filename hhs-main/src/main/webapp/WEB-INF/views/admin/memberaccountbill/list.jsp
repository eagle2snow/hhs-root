...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						<div class="box-header with-border">
							<h3 class="box-title">会员账户账单列表</h3>
						</div>
						<!-- /.box-header -->
						<div class="box">
										...
										<tr>
											...
											<td>${model.selfId}</td>
											 ...
											 <th> 
											 	...
											 	<c:if test="${model.type == 9}">提现</c:if>
											 </th>
											
											 <th>
											 	<c:if test="${model.type == 1}">+${model.money}</c:if>
		...
		function edit(id){
				...
				openPerRe("编辑会员账户账单", 90,90,'${adp}update/'+id+'.htm');
