...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
									...
									<tbody>
										...
										<tr>
											...
											<td>${model.id}</td>
											 ...
											 <th>
												  ${model.pathway eq 1 ? "一级分销提成":(model.pathway eq 2 ? "二级分销提成":(model.pathway eq 3 ? "充值":"退还")) }
											 </th>
											
											 <th>${model.totalMoney}</th>
											
											 <th>${model.recordMoney}</th>
		...
		function edit(id){
				...
				openPerRe("编辑会员账单", 90,90,'${adp}update/'+id+'.htm');
